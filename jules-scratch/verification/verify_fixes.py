...
def test_dark_mode_and_visualizations(page: Page):
    ...
    # The name is now "テーマを切り替え"
    toggle_button = page.locator('button:has-text("テーマを切り替え")')
    toggle_button.click()
    ...
    expect(page.get_by_text("分析実行中...")).to_be_hidden(timeout=120000)
    ...
    # The chart and table titles might be different, so we'll look for the component containers
